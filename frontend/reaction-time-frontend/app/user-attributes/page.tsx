...
import { ADD_USER, type UserAttributes, DeviceType, Gender } from "../utils/sendUserAttributes";

import ThemeProvider from "../providers/theme-provider"; // path to your ThemeProvider
import LofiThemeModeSelector from "../components/LofiThemeModeSelector"; // path to theme toggle
import type { Mode } from "../hooks/useThemeMode";
